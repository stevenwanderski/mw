(function($) {
	...
	*/
	...
	$.fn.getTwitter = function(options) {
		...
		$.getScript("http://twitter.com/javascripts/blogger.js", function(data, textStatus){
			$.getScript("http://search.twitter.com/search.json?q=from:"+o.userName+"&rpp="+o.numTweets+"&callback=twitterCallback2", function() {
